...
//=========================================
    switch(fileNum)
    {
        ...
        case 0: nameOfFile.assign("aguia-small.bmp");
                // larger externally-supplied P3 PPM
                break;
        case 1: nameOfFile.assign("facebook small.bmp");
                // RGBA test-signal image shows byte order(243x146 x 32bpp: RGBA)
                break;
        case 2: nameOfFile.assign("twitter small.bmp");
                // RGB text signal image
                break;
        case 3: nameOfFile.assign("KapnKoneBMP_copy_reasonably_small.bmp");
